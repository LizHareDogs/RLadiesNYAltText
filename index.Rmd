...
You can see examples of`.Rmd` code for  including alt text for [these very slides](https:lizharedogs.github.com)
...
`.Rmd` code:  
blah blah blah `` `r
load("p1.Rda"); get_alt_text(p1)` `` blah blah blah  

Rendered version:    
blah blah blah `r load("p1.Rda"); get_alt_text(p1)` blah blah blah



---

# 'ggplot2::get_alt_text() Caution

The object you're getting the alt text from has to be available in the same
chunk or inline R code where you call `get_alt_text`
...
- [Silvia Canelón](https://silviacanelon.com), for the [Xaringan](https://github.com/yihui/xaringan) template
